...
const Header = styled.header`
  ...
  a { color: ${props => props.theme.colors.lightest}; }
  padding: 6px 0;
`;
    ...
    <ThemeProvider theme={theme}>
        ...
        <Container>
          <NavGridContainer container>
            <Grid item>
              <Link to="/">
                <LogoImage
                  src={require("../images/tdp-logo-2022-60x60.png")}
                  alt="TDP Logo"
                />
              </Link>
            </Grid>
      ...
      {breadcrumb && (
        <BreadcrumbTrail>
          <Container>
            {breadcrumb.map(item => {
              if (!item.path) return <span className="item">{item.label}</span>;
              return (
                <span className="item">
      ...
      <Footer>
        <Container className="footerContainer">
          <div className="footerLogo">
            <img src={require("./../images/tdp-logo-2022-120x120.png")} alt="TDP" />
          </div>
          ...
          <div className="badgeList">
            <BadgeImage
              src={require("./../images/AAA-logo-2025-FI-transparent.png")}
              alt="AAA-luottoluokitus"
            />
            <BadgeImage
              src={require("./../images/luotettavakumppani_250x124.jpg")}
              alt="Luotettava kumppani"
            />
            <BadgeImage
              src={require("./../images/sy-jasenyritysbanneri-fi_250x124.jpg")}
              alt="Suomen yrittäjät jäsenyritys"
            />
            <BadgeImage
              src={require("./../images/STANDING_BLACK_1080x952.png")}
              alt="Asiakastieto"
            />
          </div>
